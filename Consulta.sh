#!/bin/bash
echo "Consultar Tablas de Cada Micro Servicio "
read -p "Ingrese por favor el financial que desea consultar `echo $'\n> '`" financial
read -p "Ingrese por favor el supplier que desea consultar `echo $'\n> '`" supplier
read -p "Ingrese por favor el Micro servicio que desea consultar `echo $'\n> '`" mservice
